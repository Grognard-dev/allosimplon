  ...
  <!-- zone d'inscription' -->
    ...
    <div id="container">
        ...
        <form action="inscription.php" method="POST">
            ...
            <input class="login" type="text" placeholder="Pseudo d'utilisateur" name="pseudo_user" required> <br>
            ...
            <input class="login" type="text" placeholder="Nom d'utilisateur" name="prenom_user" required> <br>

            <label><b>Email d'utilisateur</b></label>
            <input class="login" type="text" placeholder="Mail d'utilisateur" name="email_user" required> <br>
