...
<tr>
    <td class="flex-initial flex-col text-black-700 text-center bg-yellow-200 px-2 py-1 m-2"><?= $acteur['ID_acteur']?></td>
    <td class="flex-initial flex-col text-black-700 text-center bg-purple-200 px-2 py-1 m-2"><?= $acteur['Nom']?></td>
...
<?php endforeach ?>
   ...
   <td class="flex-initial text-black-700 text-center  px-4 py-1 m-2">
    <a class="shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded m-4"  href="insertion_acteur.php">Ajouter un Acteur</a></td>
     <td class="flex-initial text-black-700 text-center  px-4 py-1 m-2">
